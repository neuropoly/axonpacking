function  [D,x0, side] = axonsSetup(axons, lawname, k)
...
h = bar(bins,n_hist/max(n_hist)*max(yth(:)));

set(h,'barwidth',0.5)
hold on
plot(xth,yth,'r', 'LineWidth',1 )
...
meanAxons      = axons.mean_theoretical{k};
varAxons       = axons.var_theoretical{k};
